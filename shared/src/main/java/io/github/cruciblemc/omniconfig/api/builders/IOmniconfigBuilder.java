...
import io.github.cruciblemc.omniconfig.api.properties.*;
...
import static io.github.cruciblemc.omniconfig.api.builders.BuildingPhase.*;
...
public interface IOmniconfigBuilder {
     ...
     */
    @PhaseOnly(PROPERTY_LOADING)
    IOmniconfigBuilder commentCategory(String category, String comment);
