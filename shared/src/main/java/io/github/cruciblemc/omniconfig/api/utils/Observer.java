package io.github.cruciblemc.omniconfig.api.utils;
 ...
 * visually final, so that only config processor itself will be able to modify their value.<br>
 ...
 * a value directly, you can call methods from this class, passing your primitive value into them
