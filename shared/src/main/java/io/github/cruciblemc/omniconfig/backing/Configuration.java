...
import io.github.cruciblemc.omniconfig.lib.FileWatcher;
...
import static io.github.cruciblemc.omniconfig.backing.Property.Type.*;
...
public class Configuration {
    ...
    public Configuration(File file, Version configVersion) {
        ...
        String basePath = (OmniconfigCore.INSTANCE.getConfigFolder()).getAbsolutePath().replace(File.separatorChar, '/').replace("/.", "");
    ...
    public static void enableGlobalConfig() {
        try {
            PARENT = new Configuration(new File(OmniconfigCore.INSTANCE.getConfigFolder().getCanonicalFile(), "global.cfg"));
        } catch (IOException e) {
